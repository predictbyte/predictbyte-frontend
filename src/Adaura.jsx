    ...
    >
      ...
      >
        ...
        <div className="col-lg-6 text-center text-lg-start">
            ...
            AdAura – Cross-Platform Ad Detection & Analytics<br></br><span className="text-primary">(Powered by PredictByte Infosoft)
            </span>{" "}
          </h1>
         
          <p className="text-muted mt-3">
                    AdAura empowers brands to gain a 360° view of their advertising impact. With our AI-driven system, we detect and analyze ads across Digital platforms, Linear TV, and OTT streaming services. This unified intelligence helps brands understand where, when, and how their ads appear — ensuring complete transparency, stronger audience targeting, and higher ROI.
          </p>
 ...
 {/* <!-- Features --> */}
    <div class="features">
      ...
      <div class="feature">🔐 DRM Encryption</div>
        ...
        <Link to="/contact">  <button className="btn btn-primary btn-lg mt-2">
            Contact Us →
          </button></Link>
...
>
  Seamless <span style={{ color: "blue" }}>AWS Integration</span> for Business
</h1>
      ...
      <div className="container my-5">
        <div className="row g-4">
          ...
          <div className="col-sm-3">
            <div className="service-card p-4 h-100 rounded shadow-sm">
              <h5 className="fw-bold">Data Insights and Predictive Analytics</h5>
  ...
  <div className="row g-4">
    ...
    <div className="col-12 col-md-6 col-lg-4">
      <div className="security-card">
        ...
        <p>
          Keep content secured by giving access only to premium members and
          prohibiting unwanted users at the same time.
        </p>
      </div>
    </div>
...
<div className="container my-5">
  <div className="row align-items-center">
    ...
    <div className="col-12 col-lg-6 mb-4 mb-lg-0">
      ...
      <p>
        VideoCrypt has become a leader in secure video streaming, partnering
        with numerous global clients. With its advanced DRM and encryption,
        it provides exceptional security, making it the preferred choice
        for video streaming solutions.
      </p>
